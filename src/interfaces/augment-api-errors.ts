...
declare module '@polkadot/api-base/types/errors' {
  interface AugmentedErrors<ApiType extends ApiTypes> {
    ...
    ipfsKey: {
      IncorrectKeyLength: AugmentedError<ApiType>;
      /**
       * Generic error
       **/
      [key: string]: AugmentedError<ApiType>;
    ...
    processValidation: {
      AlreadyDisabled: AugmentedError<ApiType>;
      AlreadyExists: AugmentedError<ApiType>;
      InvalidProgram: AugmentedError<ApiType>;
      InvalidVersion: AugmentedError<ApiType>;
      NonExistingProcess: AugmentedError<ApiType>;
      /**
       * Generic error
       **/
      [key: string]: AugmentedError<ApiType>;
