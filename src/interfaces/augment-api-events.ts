...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    doas: {
       ...
       **/
      DidAs: AugmentedEvent<ApiType, [Result<Null, SpRuntimeDispatchError>]>;
      /**
       * A doas_root just took place. \[result\]
       **/
      DidAsRoot: AugmentedEvent<ApiType, [Result<Null, SpRuntimeDispatchError>]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    ipfsKey: {
      UpdateKey: AugmentedEvent<ApiType, [Bytes]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    processValidation: {
      ProcessCreated: AugmentedEvent<ApiType, [Bytes, u32, Vec<PalletProcessValidationBinaryExpressionTreeBooleanExpressionSymbol>, bool]>;
      ProcessDisabled: AugmentedEvent<ApiType, [Bytes, u32]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
